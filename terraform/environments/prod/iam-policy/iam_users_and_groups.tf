...
locals {
  groups = {
    ...
    developers       = { name = "Developers", role_arn = aws_iam_role.developer.arn, users = ["siyeon.hwang", "kwanghyeok.choi"] }
    ...
    ml_engineers     = { name = "MLEngineers", role_arn = aws_iam_role.ml_engineer.arn, users = ["donghoon.choi"] }
    ai_platform      = { name = "AIPlatform", role_arn = aws_iam_role.ai_platform.arn, users = ["jihyun.jang"] }
